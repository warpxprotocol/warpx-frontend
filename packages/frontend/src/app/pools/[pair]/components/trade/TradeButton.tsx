...
export default function TradeButton({
  ...
  return (
    <button
      className="bg-gray-800 text-[11px] font-medium text-white p-1.5 w-full hover:bg-gray-700 disabled:bg-gray-700 disabled:text-gray-500 disabled:cursor-not-allowed transition border border-white disabled:border-gray-700"
