...
import type { Bytes, Option, Vec, bool, u32, u64, u128 } from '@polkadot/types-codec';
  ...
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    hybridOrderbook: {
      ...
      frozenAssets: AugmentedQuery<
        ...
        [AccountId32, FrameSupportTokensFungibleUnionOfNativeOrWithId]
      > &
        QueryableStorageEntry<
          ApiType,
          [AccountId32, FrameSupportTokensFungibleUnionOfNativeOrWithId]
      ...
      pools: AugmentedQuery<
        ...
        ) => Observable<Option<PalletHybridOrderbookPool>>,
        [
          ITuple<
            [
              FrameSupportTokensFungibleUnionOfNativeOrWithId,
