...
import type { Bytes, Compact, Vec, bool, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    hybridOrderbook: {
       ...
       **/
      addLiquidity: AugmentedSubmittable<(baseAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, quoteAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, baseAssetDesired: u64 | AnyNumber | Uint8Array, quoteAssetDesired: u64 | AnyNumber | Uint8Array, baseAssetMin: u64 | AnyNumber | Uint8Array, quoteAssetMin: u64 | AnyNumber | Uint8Array, mintTo: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [FrameSupportTokensFungibleUnionOfNativeOrWithId, FrameSupportTokensFungibleUnionOfNativeOrWithId, u64, u64, u64, u64, AccountId32]>;
      cancelOrder: AugmentedSubmittable<(baseAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, quoteAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, price: u64 | AnyNumber | Uint8Array, orderId: u64 | AnyNumber | Uint8Array, quantity: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [FrameSupportTokensFungibleUnionOfNativeOrWithId, FrameSupportTokensFungibleUnionOfNativeOrWithId, u64, u64, u64]>;
      /**
       ...
       **/
      createPool: AugmentedSubmittable<(baseAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, quoteAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, takerFeeRate: Permill | AnyNumber | Uint8Array, tickSize: u64 | AnyNumber | Uint8Array, lotSize: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [FrameSupportTokensFungibleUnionOfNativeOrWithId, FrameSupportTokensFungibleUnionOfNativeOrWithId, Permill, u64, u64]>;
      limitOrder: AugmentedSubmittable<(baseAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, quoteAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, isBid: bool | boolean | Uint8Array, price: u64 | AnyNumber | Uint8Array, quantity: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [FrameSupportTokensFungibleUnionOfNativeOrWithId, FrameSupportTokensFungibleUnionOfNativeOrWithId, bool, u64, u64]>;
      marketOrder: AugmentedSubmittable<(baseAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, quoteAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, quantity: u64 | AnyNumber | Uint8Array, isBid: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [FrameSupportTokensFungibleUnionOfNativeOrWithId, FrameSupportTokensFungibleUnionOfNativeOrWithId, u64, bool]>;
      /**
       * Allows you to remove liquidity by providing the `lp_token_burn` tokens that will be
       * burned in the process. With the usage of `amount1_min_receive`/`amount2_min_receive`
       * it's possible to control the min amount of returned tokens you're happy with.
       **/
      removeLiquidity: AugmentedSubmittable<(baseAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, quoteAsset: FrameSupportTokensFungibleUnionOfNativeOrWithId | { Native: any } | { WithId: any } | string | Uint8Array, lpTokenBurn: u64 | AnyNumber | Uint8Array, baseAssetMinReceive: u64 | AnyNumber | Uint8Array, quoteAssetMinReceive: u64 | AnyNumber | Uint8Array, withdrawTo: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [FrameSupportTokensFungibleUnionOfNativeOrWithId, FrameSupportTokensFungibleUnionOfNativeOrWithId, u64, u64, u64, AccountId32]>;
      /**
